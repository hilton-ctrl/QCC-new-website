...
```json
{
  ...
  "properties": {
    ...
    "email":        { "type": "string", "description": "The customer's email address. Ask every customer for this. Leave out only if they declined to give one." },
...
```json
{
  ...
  "properties": {
    ...
    "email":        { "type": "string", "description": "The customer's email address. Ask every customer for this." },
